# Introduction
This app is still very much under construction. The intention is to have a
configurable timer to help speakers at CppCon 2018. The timer will eventually
keep track of the schedule (as configured) and show how much time there is left
